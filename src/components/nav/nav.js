    ...
    render() {
        ...
        return ( 
            ...
            <footer className="nav-wrapper">
                <ul className="nav">
                    <li className="nav-item">
                        <Link to="/profile" className="nav-button btn nav-btn-style nav-link center profile-btn">Profile</Link>
                    </li>

                    <li className="nav-item">
                        <Link to="/events" className="nav-button btn nav-link  center event-btn">Events</Link>
                    </li>

                    <li className="nav-item">
                        <Link to="/sign-out" className="nav-button btn nav-link  center sign-out-btn">Sign Out</Link>
                    </li>
