        ...
        <div className="content-container ">
            <div className="about-author-container">
                ...
                <div className="about-url">
                    <a class="btn about-linkedin" href="https://www.linkedin.com/in/matt-staniszewski-57157820/">LinkedIn</a>
                </div>
            </div>
            <br/>
            <div className="about-author-container">
                ...
                <div className="about-url">
                    <a class="btn about-linkedin" href="https://www.linkedin.com/in/billdarnalljr/">LinkedIn</a>
                </div>
            </div>
            <br/>
            <div className="about-author-container">
                ...
                <div className="about-url">
                    <a class="btn about-linkedin" href="https://www.linkedin.com/in/christopher-s-07a09b171/">LinkedIn</a>
                </div>
            </div>
        </div>
    </div>
