    ...
    <div className="about-content-container ">
      <div className="about-author-container">
        ...
        <div className="about-url">
          <a className="btn about-linkedin" href="https://www.linkedin.com/in/matt-staniszewski-57157820/" target="_blank" >LinkedIn</a>
        </div>
      </div>
      <br />
      <div className="about-author-container">
        ...
        <div className="about-url">
          <a className="btn about-linkedin" href="https://www.linkedin.com/in/billdarnalljr/" target="_blank" >LinkedIn</a>
        </div>
      </div>
      <br />
      <div className="about-author-container">
        ...
        <div className="about-url">
          <a className="btn about-linkedin" href="https://www.linkedin.com/in/christopher-s-07a09b171/" target="_blank" >LinkedIn</a>
        </div>
      </div>
    </div>
  </div>
